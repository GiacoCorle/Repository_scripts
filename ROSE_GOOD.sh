...
#need to run a manella enhancer calling for sampleg008_input005 peak done with the below script
...
for input in /Volumes/SAM_BAM/DKP_H3K27ac_april/SORTED_BAM/sorted_G*I*.bam ;do
      ...
      if [ "$count_1" = "$count_2"  -a "$count_1" = "$count_3" -a "$count_2" = "$count_3" -a "$count_1" -ge 16 ] ; then
...
#ROSE good sample 013
#python ROSE_main.py -g hg19 -i /Volumes/SAM_BAM/DKP_H3K27ac_april/MACS2_DKP_april_h3k27ac/sorted_G_DKP_013_INPUT_sorted_G_DKP_013_H3K27ac_peaks.narrowPeak.bed -r /Volumes/SAM_BAM/DKP_H3K27ac_april/SORTED_BAM/sorted_G_DKP_013_H3K27ac.bam -o /Volumes/SAM_BAM/DKP_H3K27ac_april/ROSE/GOOD/ -c /Volumes/SAM_BAM/DKP_H3K27ac_april/SORTED_BAM/sorted_G_DKP_013_INPUT.bam
