...
fisher.ngs <- function(datos1, datos2, norm = "n", long = NULL,
  ...
  list("p.value" = fish.pv, "adj.p.val" = fish.adjP)
}
...
biodetection <- function(dat1, dat2 = NULL, infobio, k = 0,
